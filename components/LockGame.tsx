...
function initLevel(
  ...
  const angles: number[] = [180, 90, 180];
        ...
        <div class="lock-stage">
          ...
          <div class="lock-disc">
            ...
            <img
              ...
              style="position:absolute; top:50%; left:50%; width:82.35%; height:82.35%; transform:translate(-50%, -50%); z-index:2;"
            >
            <img
              id="img1"
              src="/assets/C03v2.png"
              style="position:absolute; top:50%; left:50%; width:62.75%; height:62.75%; transform:translate(-50%, -50%); z-index:3;"
            >
            <img
              id="img0"
              src="/assets/C02v2.png"
              style="position:absolute; top:50%; left:50%; width:43.14%; height:43.14%; transform:translate(-50%, -50%); z-index:4;"
            >
            <div
              class="lock-hit"
              data-i="2"
              style="position:absolute; top:50%; left:50%; width:82.35%; height:82.35%; transform:translate(-50%, -50%); z-index:8;"
            ></div>
            <div
              class="lock-hit"
              data-i="1"
              style="position:absolute; top:50%; left:50%; width:62.75%; height:62.75%; transform:translate(-50%, -50%); z-index:9;"
            ></div>
            <div
              class="lock-hit"
              data-i="0"
              style="position:absolute; top:50%; left:50%; width:43.14%; height:43.14%; transform:translate(-50%, -50%); z-index:10;"
            ></div>
            <div
              class="lock-center-blocker"
              style="position:absolute; top:50%; left:50%; width:24.51%; height:24.51%; transform:translate(-50%, -50%); z-index:11;"
            ></div>
  ...
  function injectStyle() {
    ...
    styleEl.innerHTML = `
      .lock-game { width:100%; height:100%; display:flex; justify-content:center; align-items:center; background:#000; overflow:hidden; }
      .lock-stage { position:relative; width:1440px; height:1024px; transform:scale(var(--scale)); transform-origin:center; flex:0 0 auto; }
      .lock-bg { position:absolute; width:100%; height:100%; object-fit:contain; }
      .lock-back-btn { position:absolute; top:5%; left:5.9%; width:7.7%; max-width:111px; cursor:pointer; z-index:30; }
      .lock-start-panel {
        position:absolute;
        top:50%;
        left:50%;
      ...
      .lock-desc h2 { margin:0 0 6% 0; font-size:38px; line-height:1.2; }
      .lock-desc p { margin:0; font-size:27px; line-height:1.5; word-break:break-word; }
      .lock-start-btn {
        position:absolute;
      ...
      .lock-disc { position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); width:70.8%; max-width:1020px; aspect-ratio:1 / 1; }
      ...
      .lock-center { position:absolute; width:24.51%; height:24.51%; top:50%; left:50%; transform:translate(-50%, -50%); }
      .lock-end-modal { position:absolute; inset:0; display:flex; justify-content:center; align-items:center; z-index:200; }
      .lock-end-wrapper { position:relative; width:1440px; height:1024px; transform:scale(var(--scale)); transform-origin:center; flex:0 0 auto; }
      .lock-end-bg { position:absolute; width:100%; height:100%; object-fit:contain; }
      .lock-end-panel { position:absolute; top:70%; left:50%; transform:translate(-50%, -50%); width:80%; aspect-ratio:675 / 188; }
      .lock-end-text { position:absolute; inset:0; width:100%; height:100%; pointer-events:none; }
      .lock-end-desc { position:absolute; top:12.8%; left:7.1%; width:83%; color:#fff; text-align:left; line-height:1.6; font-size:27px; }
